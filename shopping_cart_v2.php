...
$products = array(
    array("id" => 1, "name" => "Product 1", "price" => 25),
    array("id" => 2, "name" => "Product 2", "price" => 50),
    array("id" => 3, "name" => "Product 3", "price" => 40),
);
...
<form method="post">
    ...
    <select name="productId" id="productId">
        <?php foreach ($products as $product): ?>
            <option value="<?php echo $product['id']; ?>"><?php echo $product['name'] . " - $" . $product['price']; ?></option>
        <?php endforeach; ?>
    </select>
